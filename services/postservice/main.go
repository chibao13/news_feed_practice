...
import (
	...
	"github.com/chibao13/news_feed_practice/services/postservice/moudle/post/posttrransport/grpcpost"
...
func runService(db *gorm.DB, secretKey string) error {
	...
	lis, err := net.Listen("tcp", common.PortgRPCPostService)
	if err != nil {
		return err
	}
	...
	api.RegisterPostRPCServer(s, grpcpost.NewgRpcPostServer(appCtx))
